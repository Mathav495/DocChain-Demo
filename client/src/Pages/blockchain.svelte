  ...
  <div class="flex flex-col gap-4 py-28 lg:flex-row">
    ...
    >
      <img
        ...
        src="https://img.freepik.com/free-vector/elegant-blue-gold-diploma-certificate-template_1017-17257.jpg?w=2000"
        alt="document"
      />

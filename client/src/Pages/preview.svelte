  ...
  <div class=" mx-auto flex items-center p-5 md:flex-row">
    <div class="overflow-x-auto">
      <table class="text-md w-full text-left text-gray-500 dark:text-gray-400">
        <thead
          class="text-md bg-gray-50 uppercase text-gray-700 hover:bg-gray-200 dark:text-gray-400"
        >
          <tr>
      ...
      <div class="mx-auto mt-10 flex justify-between">
        <button class="rounded-lg bg-teal-500 px-6 py-2 text-lg text-white"
          >sign</button
        >
        <button
          on:click={publishdoc}
        ...
        <a class="rounded-lg bg-teal-500 px-6 py-2 text-lg text-white " href="/"
          >revoke</a
        >
      </div>
    </div>
